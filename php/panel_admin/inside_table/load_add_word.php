...
function load_add_word($table, $pdo){
    ...
    <span>EN: </span>
    <input type="text" name="dodaj_element1" onInput="this.parentNode.dataset.value = this.value" size="1" placeholder="Wyrażenie polskie:" value=>
    </label>
    <label class="input-sizer">
    <span>PL: </span>
    <input type="text" name="dodaj_element2" onInput="this.parentNode.dataset.value = this.value" size="1" placeholder="Wrażenie angielskie:"  value=>
    </label>
    <label class="input-sizer">
    <span> </span>
